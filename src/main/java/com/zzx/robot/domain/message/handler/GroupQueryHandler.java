...
public class GroupQueryHandler implements MessageHandler {
    ...
    public ObjectNode handle(Message message) {
        ...
        String groupId = message.getHeader(MessageConstants.Header.GROUP_ID, String.class);
        ...
        if ("我".equals(characterName)) {
            ...
            if (user == null || !StringUtils.hasText(user.getMapleName())) {
                return MessageConstructor.newGroupMessage(groupId, "未绑定角色");
            } else {
        ...
        return MessageConstructor.newGroupMessage(groupId, robotMessage);
